...
public class PmsUserFacadeImpl implements PmsUserFacade {
	...
	private static final Logger LOGGER = LoggerFactory.getLogger(PmsUserFacadeImpl.class);
	...
	public void create(PmsUser pmsUser) {
		LOGGER.info("wusc.edu.facade.user.service.impl.PmsUserFacadeImpl.create，pmsUser{}:",pmsUser);
	...
	public PageBean listPage(PageParam pageParam, Map<String, Object> paramMap) {
		LOGGER.info("wusc.edu.facade.user.service.impl.PmsUserFacadeImpl.listPage，paramMap{}:",paramMap);
